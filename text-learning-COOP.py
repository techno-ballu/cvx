# -*- coding: utf-8 -*-
"""
Created on Thu Mar 19 23:53:08 2015
...
testingfilename = '../coop-final.csv'
...
bagOfWordsRigsCalc = [ 'RIGLESS', 'ENERGY', 'SERVICES', 'HELMERICH', 'MOUNTAIN', '513' ]

bagOfWordsStatusEnd = [ 'DOWN', 'DONW', 'FLOW BACK', 'FB', 'FLWG', 'HUNG', 'SHUT IN', 'S/I', 'SI', 'SDFN', 'SION', 'SECURE', 
                       'DRILL', 'DRLG', 'CMNT', 'NIPPLE', 'WAIT ON', 'TOH', 'TIH'  ]

# add text extracted features
#bagOfWordsSumOps = [ 'SPUD','MIRU','RU', 'R/U','RIG UP', 'TOH', 'TOOH', 'TRIP OUT', 'DRILLING', 
...
#              'FISHING', 'PRODUCTION','N/U', 'N/D','NDBOP',
#              'SURFACE', 'SRF', 'INTERMEDIATE', 'WH & TEST']  # 'CEMENT', 'CMT','LDDP', 'LD DP', '13-3/8 CSG', '8-5/8 CSG', '5-1/2 CSG', '9-5/8 CSG'
...
# clone the training to predict completions
#completions = training.copy()

# Extract features to first predict completions
#extractFeatures(completions, 'completions-features.csv', 'RIGSCALC', bagOfWordsRigsCalc)
#extractFeatures(completions, 'completions-features.csv', 'STATUSEND', bagOfWordsStatusEnd)
#
#extractFeatures(testing, 'completions-test-features.csv', 'RIGSCALC', bagOfWordsRigsCalc)
#extractFeatures(testing, 'completions-test-features.csv', 'STATUSEND', bagOfWordsStatusEnd)

# Extract features to first predict completions
extractFeatures(training, 'training-features.csv', 'SUMMARYOPS', bagOfWordsSumOps)
extractFeatures(testing, 'completions-test-features.csv', 'SUMMARYOPS', bagOfWordsSumOps)

#X = completions[completions.columns - ['PLANNEXTRPTOPS','SUMMARYOPS','RIGSCALC','Code 1', 'Code 2','Code 3',
#                         'STATUSEND','MANUALTVD','RIGTIME','StringFromCode','PhaseFromCode', 'TVD', 'RIGDAYSCALC','DTTMEND','DTTMSTART' ]]
X = training[training.columns - ['PLANNEXTRPTOPS','SUMMARYOPS','RIGSCALC','Code 1', 'Code 2','Code 3',
                         'STATUSEND','MANUALTVD','RIGTIME','StringFromCode','PhaseFromCode', 'TVD', 'RIGDAYSCALC','DTTMEND','DTTMSTART', 'Code 3_ML' ]]
x_test = testing[testing.columns - ['PLANNEXTRPTOPS','SUMMARYOPS','RIGSCALC','Code 1', 'Code 2','Code 3',
                         'STATUSEND','MANUALTVD','RIGTIME','StringFromCode','PhaseFromCode', 'TVD', 'RIGDAYSCALC','DTTMEND','DTTMSTART', 'Code 3_ML' ]]
...
print(names(testing))
#testing = testing[['DAYSFROMSPUDCALC', 'DTTMEND', 'DTTMSTART', 'PLANNEXTRPTOPS', 'RIGSCALC', 'RIGDAYSCALC', 'RIGTIME', 
#                  'STATUSEND', 'SUMMARYOPS', 'MANUALTVD', 'Code 3_ML']]
#
#testing.to_csv('testing-no-completions.csv', sep=',', encoding='utf-8')
#training.to_csv('training-completions-classified.csv', sep=',', encoding='utf-8')
